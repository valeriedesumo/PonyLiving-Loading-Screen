/* Blood Spatter (by Suraj Thapar)
    Displays an animated spatter of blood
*/

$(function() {
 // Customisable parameters
 var image  = "effect_spatter.png",
     width  = 300,
     height = 500;
 ...
 // Modern browsers usually support requestAnimationFrame, but Gmod uses webkitRequestAnimationFrame
