/* Rising Hearts (based on Falling Leaves by PremiumCoding)
...
$(function() {
 ...
 var fps = 45,            // Frames per second
     ...
     speedC = 0.7,        // Range of speed of hearts
     minSpeed = 0.5,      // Minimum leaf speed
     zIndex = 2;          // CSS stacking order

 // Heart file paths
 var heartTypes = new Array(
  "img/effect_heart1.png",
  "img/effect_heart2.png",
  "img/effect_heart3.png");
 ...
 setInterval(function() {
  for (i = 0; i < numberOfHearts; i++) {
   ...
   // When hearts reach certain browser height they are transported back to the beginning
   if (Ypos[i] < -50) {
    Ypos[i] = WinHeight + 50;
